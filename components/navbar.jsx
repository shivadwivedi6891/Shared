...
export default function Navbar() {
  ...
  const headlines = [
    "🔥 Bid Now! Best luxury cars in India available!",
    "🚗 Don't miss Audi R8 live auction – 2 days left!",
    "📢 New vehicles added daily. Stay tuned!",
    "💰 Place your bid above reserve price to win!",
  ];
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <Link href="/" className="flex items-center space-x-3 group">
              <div className="p-2 bg-gradient-to-r from-yellow-600 to-blue-600 rounded-xl group-hover:scale-110 transition-transform duration-300">
      ...
      {/* 🔽 Headlines / Scrolling Ticker Section */}
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-2 px-4 text-sm font-semibold animate-slide-in">
