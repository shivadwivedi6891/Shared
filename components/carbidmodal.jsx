...
// const sampleImages = [
//   'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTGlILGsQFXV2GkOiPX_BIrN9aFilf8rGiOpw&s',
//   'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSpB6ZAURL86Xp0XbrZ4yIY-vcvvji2TvYhKgI7fxIa2m-TcU4&s',
//   'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ3DeF-35Qs9iF7OR9TFQjH_YOELsHg4pWYbZXvs5i23aFudsA&s',
//   'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR2d0OVzjkPw3JuSVwnmzIuBTfX5gHcDhCVasMWFL7AU-5egI8&s',
// ];
...
//         <div className="flex justify-between flex-wrap gap-4 mb-4">
//           <div>
//             <h2 className="font-bold text-lg">{car?.title || 'LPT 3718 TC'}</h2>
//             <p className="text-sm text-gray-500 dark:text-gray-400">Mfg. Year: 2017</p>
//             <p className="text-sm text-gray-500 dark:text-gray-400">
//               Evaluation Report: <a href="#" className="text-blue-500 underline">View</a>
//             </p>
//           </div>
...
//             <p>Your Last Bid: <span className="text-gray-700 dark:text-white">No bid placed</span></p>
//             <p>No. of Bids: 0</p>
//             <p>Contract No: <span className="font-medium">5002427126</span></p>
//           </div>
//         </div>
...
//             {activeTab === 'Other Details' && (
//               <p className="text-gray-700 dark:text-gray-200">
//                 Insurance Validity: Expired<br />
//                 RC Status: Available<br />
//                 Permit: National
//               </p>
//             )}
//             {activeTab === 'Evaluation Report' && (
//               <p className="text-gray-700 dark:text-gray-200">
//                 This vehicle has been evaluated and is in fair condition. Tyres need replacement. Body dented.
//               </p>
//             )}
//           </div>

//           <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg shadow-inner space-y-4">
//             <p className="text-lg">Open Bid: <strong>₹80,000,000</strong></p>
//             <p>Your Last Bid: <span className="text-gray-500">No bid placed</span></p>
