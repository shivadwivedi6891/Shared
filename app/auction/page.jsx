...
{
  id: 25,
  title: "Coimbatore Lot-4",
  state: "Tamil Nadu",
  category: "Car",
  date: "Aug 04, 2025",
  published: "03-08-2025 10:30:00 AM",
  start: "04-08-2025 09:30:00 AM",
  end: "06-08-2025 06:00:00 PM",
  totalVehicles: 14,
  totalBids: 16,
  myBids: 0,
  image: "https://tse4.mm.bing.net/th/id/OIP.W0oAGnaKcGW0bZaLhQXMhQHaE8?pid=Api&P=0&h=180"
}
  ...
  return (
    <div className="flex flex-col lg:flex-row bg-white min-h-screen text-black">
      ...
      <main className="w-full lg:w-3/4 p-4">
        ...
        {showMobileFilters && (
          <form onSubmit={handleFilterSubmit} className="lg:hidden mb-6 border border-gray-300 rounded p-4">
        ...
        <h1 className="text-2xl font-bold mb-4">
          {filters.state ? Auctions in `${filters.state}` : 'Live Auctions List'}
        </h1>
