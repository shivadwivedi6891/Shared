...
//   return (
//     <div className="min-h-screen bg-gradient-to-br from-blue-100 to-purple-100 p-8">
//       <h1 className="text-4xl font-bold text-center text-blue-900 mb-2">Browse Vehicle Categories</h1>
//       <p className="text-center text-gray-700 mb-10">Select your preferred vehicle category to explore live auctions</p>
